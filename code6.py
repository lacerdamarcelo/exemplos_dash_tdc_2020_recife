...
fig.update_layout(yaxis_title="Regiões", xaxis_title="Contagem de focos",
...
app.layout = html.Div(children=[
    ...
    html.Div(children=[dcc.Graph(id='fig3',figure=fig3)],
             style={'marginLeft': '50%'}),
    html.Iframe(src="https://open.spotify.com/embed/track/6CRtIYDga4VKW5sV5rfAL3",
                style={"frameborder": "0", "allowtransparency":"true",
                       "allow": "encrypted-media", 'width': '50%'}),
    dcc.Graph(id='fig2'),
    dcc.Dropdown(
        id='region_filter',
        options=[
